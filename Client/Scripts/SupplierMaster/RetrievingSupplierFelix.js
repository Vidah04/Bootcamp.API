...
function tampil() {
    ...
    $.ajax({
        type: 'get',
        url: 'http://localhost:3146/api/Suppliers/',
...
function cari() {
    $.ajax({
        type: 'get',
        url: "http://localhost:3146/api/Suppliers/" + $('#jns').val() + "&&name=" + $('#cari').val(),
        dataType: 'JSON',
        success: function (data) {
            var html = '';
            var i, k;
...
function getById(id) {
    $.ajax({
        url: 'http://localhost:3146/api/Suppliers/' + id,
        type: 'get',
        dataType: 'json',
        success: function (data) {
            tampil();
...
function Edit() {
    ...
    if (supplier.name == "") {
        ...
        $.ajax({
            url: 'http://localhost:3146/api/Suppliers/' + supplier.id,
            type: 'PUT',
            data: supplier,
            dataType: 'json',
            success: function (data) {
